  ...
  return (
    <div className="glass-card p-6 hover:bg-white/10 transition-all duration-300">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm mb-4">
        <div className="text-white/50">Пол:</div>
        <div>{GENDER_MAP[perfume.gender]}</div>
        <div className="text-white/50">Тип:</div>
        <div>{TYPE_MAP[perfume.pType]}</div>
        <div className="text-white/50">Концентрация:</div>
        <div>{perfume.concentration}%</div>
      </div>

      <div className="space-y-3 mb-4">
        <div>
          <p className="text-xs text-white/40 uppercase tracking-wider mb-1">Верхние ноты</p>
        ...
        <div>
          <p className="text-xs text-white/40 uppercase tracking-wider mb-1">Сердечные ноты</p>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <p className="text-xs text-white/40 uppercase tracking-wider mb-1">Базовые ноты</p>
          <div className="flex flex-wrap gap-2">
      ...
      {aiDescription && (
        <div className="border-t border-white/10 pt-4 mt-4">
          <p className="text-xs text-white/40 uppercase tracking-wider mb-2">ИИ-описание</p>
