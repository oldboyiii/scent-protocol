  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 space-y-8 relative z-10">
      ...
      <div className={`group relative rounded-2xl p-8 backdrop-blur-xl bg-gradient-to-br ${style.bg} ${style.glow} border ${style.border} overflow-hidden transition-all duration-500`}>
        ...
        <div className="relative flex items-start justify-between mb-6">
          <div>
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              ...
              {isGenesis && (
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border backdrop-blur-md bg-amber-500/30 text-amber-100 border-amber-400/50 flex items-center gap-1">
        ...
        <div className={`relative rounded-lg p-4 text-white/70 italic border-l-2 mb-6 ${isGenesis ? 'bg-amber-950/30 border-amber-400/50' : 'bg-black/30 border-white/10'}`}>
          {description}
        </div>
