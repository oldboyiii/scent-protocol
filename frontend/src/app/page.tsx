    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-center">
        <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-scent-gold via-white to-scent-rose bg-clip-text text-transparent">
          Цифровой парфюмерный дом
        </h2>
        <p className="text-xl text-white/60 max-w-2xl mx-auto mb-8">
          Создавай уникальные ароматы с ИИ. Built on Arc.
          Каждая формула — NFT-сертификат владения.
        </p>
      ...
      {perfumes.length > 0 && (
        <section className="max-w-6xl mx-auto px-4 pb-20">
          <h3 className="text-2xl font-bold mb-8 text-center">Ваша коллекция</h3>
